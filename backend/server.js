...
if (BREVO_API_KEY?.startsWith("xsmtpsib-")) {
  console.warn("BREVO_API_KEY appears to be an SMTP key (xsmtpsib-). Use Brevo API key from SMTP & API > API Keys (xkeysib-) for SDK calls.")
}
...
const allowedOrigins = process.env.ALLOWED_ORIGINS
  ...
  : ["http://localhost:5173", "http://127.0.0.1:5173", "http://localhost:5174", "http://127.0.0.1:5174", "http://localhost:5175", "http://127.0.0.1:5175", "https://electricalecommerce-main.vercel.app", "https://electricalecommerce-main-quf6x8udf.vercel.app"];
